...
Spells.WARLOCK = {
    Abilities = {
		...
		DetectInvisibility = {Ranks = {2970}},
		DetectGreaterInvisibility = {Ranks = {11743}},
        ...
        RainOfFire = {Ranks = {20754, 5740, 6219, 11677, 11678}, CastType = "Ground"},
